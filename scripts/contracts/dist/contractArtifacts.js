...
let IMainGate;
try {
  IMainGate = require("../../../artifacts/contracts/MainChain/MainBridge/IMainGate.sol/IMainGate.json");
} catch (_a1) {
  console.log("a1: ", _a1);
}
...
let MainGate;
try {
  MainGate = require("../../../artifacts/contracts/MainChain/MainBridge/MainGate.sol/MainGate.json");
} catch (_a3) {
  console.log("a3: ", _a3);
}
...
let ISideGate;
try {
  ISideGate = require("../../../artifacts/contracts/SideChain/SideBridge/ISideGate.sol/ISideGate.json");
} catch (_a7) {
  console.log("a7: ", _a7);
}
...
let SideGate;
try {
  SideGate = require("../../../artifacts/contracts/SideChain/SideBridge/SideGate.sol/SideGate.json");
} catch (_a9) {
  console.log("a9: ", _a9);
}
