...
exports.DEFAULT_SIDE_CONTRACT_ADDRESSES = {
  SideGate: contracts_1.predeploys.SideGate,
  SideStandardBridge: contracts_1.predeploys.SideStandardBridge,
  OVM_SideToMainMessagePasser:
    contracts_1.predeploys.OVM_SideToMainMessagePasser,
...
exports.CONTRACT_ADDRESSES = {
  4: {
    mainChain: {
      ...
      MainGate: "0xEcC89b9EDD804850C4F343A278Be902be11AaF42",
...
const getOEContract = (contractName, mainChainId, opts = {}) => {
  ...
  if (addresses === undefined && opts.address === undefined) {
    throw new Error(
      `cannot get contract ${contractName} for unknown L1 chain ID ${mainChainId}, you must provide an address`
    );
  }
  return new ethers_1.Contract(
    coercion_1.toAddress(
      opts.address ||
        addresses.mainChain[contractName] ||
        addresses.sideChain[contractName]
    ),
    contracts_1.getContractInterface(
      NAME_REMAPPING[contractName] || contractName
    ),
...
const getAllOEContracts = (mainChainId, opts = {}) => {
  ...
  for (const [contractName, contractAddress] of Object.entries(
    ...
    mainContracts[contractName] = exports.getOEContract(
      contractName,
      mainChainId,
      {
        address:
  ...
  for (const [contractName, contractAddress] of Object.entries(
    ...
    sideContracts[contractName] = exports.getOEContract(
      contractName,
      mainChainId,
      {
        address:
...
const getBridgeAdapters = (mainChainId, messenger, opts) => {
  ...
  for (const [bridgeName, bridgeData] of Object.entries(
    Object.assign(
      Object.assign({}, exports.BRIDGE_ADAPTER_DATA[mainChainId] || {}),
